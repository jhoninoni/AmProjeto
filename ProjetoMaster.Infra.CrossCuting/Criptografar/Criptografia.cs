...
namespace ProjetoMaster.Infra.CrossCuting.Criptografar
{
    public class Criptografia
    {
        ...
        /// </summary>     
        private readonly byte[] _bIv = { 0x50, 0x08, 0xF1, 0xDD, 0xDE, 0x3C, 0xF2, 0x18, 0x44, 0x74, 0x19, 0x2C, 0x53, 0x49, 0xAB, 0xBC };
        ...
        /// </summary>     
        private readonly string _chaveCript = ConfigurationSettings.AppSettings["ChaveCriptografia"] ?? "A7QiuXAvZ4UhZalhcyBpl29gLmluamThFWagLyKKRVM=";
        ...
        public string Encrypt(string text)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(text))
                {
                    ...
                    byte[] bKey = Convert.FromBase64String(_chaveCript);
                    ...
                    CryptoStream encryptor = new CryptoStream(
                        mStream,
                        rijndael.CreateEncryptor(bKey, _bIv),
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(text))
                {
                    ...
                    CryptoStream decryptor = new CryptoStream(
                        mStream,
                        rijndael.CreateDecryptor(bKey, _bIv),
                        CryptoStreamMode.Write);
